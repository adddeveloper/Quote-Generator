...
.then(()=>{
    ...
    if(isInt(window.location.href.split("#")[1])){
        mssg__.innerHTML = ddata[parseInt(window.location.href.split("#")[1])].text;
        author.innerHTML = ddata[parseInt(window.location.href.split("#")[1])].author;
        if(ddata[randnum].author === null){
            author.innerHTML = "...";
        }
    } else {
        randnum = Math.floor(Math.random()* ddata.length);
        mssg__.innerHTML = ddata[randnum].text;
        author.innerHTML = ddata[randnum].author;
        if(ddata[randnum].author === null){
            author.innerHTML = "...";
        }
    }
